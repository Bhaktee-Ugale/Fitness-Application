...
public class MeActivity extends AppCompatActivity {
    ...
    private String resttxt, countdown;
    private String np;
    ...
    public void show(String str){
        ...
        set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String r = restTv.getText().toString(), c = countdownTv.getText().toString();

                dbHelper.updateRestCountdown(r.substring(0, r.length()-1), c.substring(0, c.length()-1));
                d.dismiss();
            }
        });
    ...
    public void loadData(){
        ModelRestCountdownTime modelRestCountdownTime = dbHelper.getRestCountdownTime();
        restTv.setText(modelRestCountdownTime.getRest()+" s");
        countdownTv.setText(modelRestCountdownTime.getCountdown()+" s");
    }
}