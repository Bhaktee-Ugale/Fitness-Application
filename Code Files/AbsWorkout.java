...
public class AbsWorkout extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        if(view==btn1){
            Intent i=new Intent(AbsWorkout.this, FBExe1.class);
            startActivity(i);
        }
        else if(view==homebt){
            Intent i=new Intent(AbsWorkout.this, HomeActivity.class);
            startActivity(i);
        }
        else if(view==reportbt){
            Intent i=new Intent(AbsWorkout.this, ReportActivity.class);
            startActivity(i);
        }
        else if(view==profilebt){
            Intent i=new Intent(AbsWorkout.this, MeActivity.class);
            startActivity(i);
        }
    }
